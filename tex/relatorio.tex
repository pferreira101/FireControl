...
\begin{figure*}[!htpb]
    \centering
    \includegraphics[width=3.5in]{grafo1c.png}
\end{figure*}
...
\end{tabular}
\caption{Representação gráfica da rede de nodos com a solução ótima obtida: os tempos de chegada do fogo a cada um dos nodos}
\end{center}
\end{table}
